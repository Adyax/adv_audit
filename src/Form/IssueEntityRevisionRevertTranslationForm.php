...
class IssueEntityRevisionRevertTranslationForm extends IssueEntityRevisionRevertForm {
  ...
  /**
   * Constructs a new IssueEntityRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'adv_audit_issue_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $adv_audit_issue_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $adv_audit_issue_revision);
  ...
  protected function prepareRevertedRevision(IssueEntityInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\adv_audit\Entity\IssueEntityInterface $default_revision */
    $latest_revision = $this->IssueEntityStorage->load($revision->id());
