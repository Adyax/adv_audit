...
class AdvAuditEntityRevisionRevertTranslationForm extends AdvAuditEntityRevisionRevertForm {
  ...
  public function getFormId() {
    return 'adv_audit_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $adv_audit_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $adv_audit_revision);
